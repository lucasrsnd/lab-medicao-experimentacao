...
- Familiaridade prévia com a ferramenta de IA: Controlada pela padronização. Todos os membros usarão exatamente a mesma ferramenta (Claude) na mesma IDE — ver `docs/ambiente-execucao.md` para o registro dessa decisão.
